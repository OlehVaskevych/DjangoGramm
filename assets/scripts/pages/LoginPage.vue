  ...
  <div class="form-container">
    ...
    <form @submit.prevent="submitForm" enctype="multipart/form-data" class="styled-form">
      ...
      <div class="button-container">
        ...
        <p>If you don`t have account <router-link to="/auth/register/">register here</router-link></p>
      </div>
    </form>
...
export default {
  data() {
    return {
      fields: [
        { id: 'id_username', label: 'Username:', name: 'username', value: '', attrs: { type: 'text', required: true}, errors: [], helpText: ''},
        { id: 'id_password', label: 'Password:', name: 'password', value: '', attrs: { type: 'password', required: true}, errors: [], helpText: ''},
      ],
      errorMessage: '',
      isSubmitting: false,
    };
