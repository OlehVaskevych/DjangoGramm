...
export default {
  data() {
    return {
      fields: [
        { id: 'title', label: 'Title', value: initialData.title, attrs: { type: 'text', required: false }, errors: [] },
        { id: 'description', label: 'Description', value: initialData.description, attrs: { type: 'text', required: false }, errors: [] },
      ],
